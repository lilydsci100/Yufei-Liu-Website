export const experience = [
  {
    ...
    caption: "Tianjin Xinda Technology Company",
    title: "Front-end Assistant",
    text: `- Front-end code optimization
           - Master and apply new technologies (React, Umi, Ant Design)
           - Increase and modify the interactivity of the user interface
  ...
  },
  {
    ...
    caption: "Quantum Technology Corp.",
    title: "Junior Engineer",
    text: `- Database Integration (SQL, GoogleSpreadSheet)
           - Data Processing & Automation (Python, Pandas)
           - Procurement Tools Development (JavaScript / Google Apps Script)
           - Spreadsheet Automation & Optimization
           - Mentor a new co-op student in JavaScript and Google Apps Script`,
    button: {
...
export const faq = [
  {
    ...
    question: "Who am I?",
    answer:
      "I am a 3rd-year Computer Science student at UBC with experience in software engineering, data processing, and front-end development. I have worked as a Junior Engineer at Quantum Technology Corp. in Canada and as a Front-end Assistant Intern in China, gaining hands-on experience with both backend and frontend technologies.",
  },
  {
    id: "1",
    question: "What are your strongest technical skills?",
    answer:
      "My strongest skills include programming in TypeScript, Java, JavaScript, Python, and C++. I am also proficient in tools such as React, VS Code, IntelliJ and WebStorm. I have experience with databases like SQL and MySQL. Additionally, I am skilled in data manipulation with Python and pandas.",
  },
  {
    id: "2",
    question: "What certifications have you earned?",
    answer:
      "I completed SQL Essential Training on LinkedIn Learning in August 2023 and Getting Started with R for Data Science in February 2023.",
  },
  {
    id: "3",
    question: "What was the purpose of your Course Management App?",
    answer:
      "he app allowed students to view, track, and save course information. I developed the backend with Java and JSON storage, and the frontend with JavaFX. A survey showed that 70% of students found it very helpful.",
  },
  {
    id: "4",
    question: "How did you build the Book Management System?",
    answer:
      "I developed the frontend with React and Ant Design and the backend with JavaScript using JSON Server and Express. I ensured secure communication using Axios, Request, CORS, and bodyParser. The system enabled adding, deleting, editing, and searching books.",
  },
  {
    id: "5",
    question: "Why did you decide to build your own website?",
    answer:
      "I built this website as a way to showcase my skills, projects and professional experiences in a more interactive and dynamic format than a traditional resume. It allows me to present not just what I’ve done but also demonstrate my technical abilities through the website itself. At the same time, it serves as a personal portfolio where recruiters and collaborators can easily access my background, explore my work and even interact with some of the projects I’ve built.",
  },
  {
    id: "6",
    question: "What soft skills have you gained through your work experiences?",
    answer:
      "I developed strong problem-solving, collaboration, and communication skills. I also learned to adapt to different work environments, from international teams to academic projects, and became better at managing time and prioritizing tasks.",
  },
];
...
export const projects = [
  ...
  {
    id: "2",
    title: "Data Processing and Tag Optimization Analyst",
    description: `- Implemented data extraction and transformation algorithms using Python and pandas to manipulate and clean large datasets from CSV files. 
    - Utilized regular expressions (regex) for string parsing and suffix management, enhancing the accuracy of tag aggregation processes. 
    - Developed custom functions to categorize and aggregate instrumentation tags based on specific criteria, optimizing data analysis and reporting workflows.`,
    detail: "0",
    link: "#",
  },
  {
    id: "3",
    title: "Exploration of an encoding strategy for images",
    description:
      "Using C++ to create a treasure map based on a given image and decode the treasure map to find the treasure. \n" +
...
export const socials = [
  ...
  },
  {
    ...
    url: "https://www.instagram.com/tjlyf2021/",
  },
  {
    id: "2",
    title: "Discord",
    icon: "/images/socials/discord.svg",
    url: "https://discordapp.com/users/1017524339521880197",
  },
];
